  ...
  class StripeResponse
    ...
    class Headers
      ...
      def initialize(hash)
        ...
        # produce a hash with all headers downcase, but do it anyway just in
      ...
      def [](name)
        ...
        # TODO: figure out what to do about duplicate headers
    ...
    attr_accessor :request_id
     ...
     # Initializes a StripeResposne object from a Net::HTTP::HTTPResponse
     # object.
